...
| `ai.New(driver, model)` | You already have a driver — including a stub, in tests | None |
...
`ai.New` does no I/O, no lookup and no credential validation. It is where every
