...
// dwarfs the rest put together; google/vertex takes only the OAuth half of it.
// A binary that talks to one provider should blank-import that provider's
// package instead; run "go mod graph" against your own build for the current
// figures.
package all
